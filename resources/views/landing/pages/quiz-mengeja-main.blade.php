    ...
    <div class="quiz-card">
        ...
        <div class="row mt-2">
            ...
            <div class="col-md-4 mb-4">
                ...
                <a href="{{ route('quiz.mengeja.cek', [$murid->id, $nomor, 'A']) }}"
                   class="pilih-link">
...
<img loading="lazy" src="{{ asset($quiz->gambar_opsi_a) }}" class="opsi-img">
            ...
            <div class="col-md-4 mb-4">
                ...
                <a href="{{ route('quiz.mengeja.cek', [$murid->id, $nomor, 'B']) }}"
                   class="pilih-link">
...
<img loading="lazy" src="{{ asset($quiz->gambar_opsi_b) }}" class="opsi-img">
            ...
            <div class="col-md-4 mb-4">
                ...
                <a href="{{ route('quiz.mengeja.cek', [$murid->id, $nomor, 'C']) }}"
                   class="pilih-link">
...
lottie.loadAnimation({
    ...
    loop: true,
    autoplay: true,
    path: "{{ asset('assets/landing/images/icon/roketquizmengeja.json') }}"
});
...
function showSuccess(){
    ...
    document.getElementById("popupImage").src="{{ asset('assets/landing/images/icon/happy.png') }}";
...
function showError(){
    ...
    document.getElementById("popupImage").src="{{ asset('assets/landing/images/icon/sad.png') }}";
...
document.querySelectorAll('.pilih-link').forEach(function(link){
    ...
    link.addEventListener('click', function(e){
        ...
        // Supaya semua pilihan tidak bisa diklik lagi
        document.querySelectorAll('.pilih-link').forEach(function(item){
